<x-app-layout>
            ...
            <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                        aria-controls="home" aria-selected="true">Reportings method</a>
                </li>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div style="display: flex; gap: 4px; justify-content: flex-end;">
                                            ...
                                            <form action="{{ route('reporting.destroy', $reporting->id) }}"
                                                method="POST"
    ...
    <div class="modal fade" id="editreportingModal" tabindex="-1" role="dialog"
        aria-labelledby="editreportingModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        document.querySelectorAll('.edit-reporting-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('editreportingForm').setAttribute('action',
