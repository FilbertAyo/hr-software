                        ...
                        <div class="row align-items-center mb-3 border-bottom no-gutters">
                                ...
                                <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                                            role="tab" aria-controls="home" aria-selected="true">Education Levels</a>
                                    </li>
                            ...
                            <div class="col-auto">
                                ...
                                <button type="button" class="btn btn-sm" onclick="reloadPage()">
                                    ...
                                    <button type="button" class="btn mb-2 btn-primary btn-sm" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo">New education<span
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered datatables" id="dataTable-1">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <div style="display: flex; gap: 4px; justify-content: flex-end;">
                                                                ...
                                                                data-education-name="{{ $education->education_level }}">
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="3" class="text-center">No education found</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="varyModalLabel">New education</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="{{ route('education.store') }}" validate>
                                @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="" id="editeducationForm">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <input type="text" class="form-control" id="editeducationName" name="education_level" required>
                            <div class="valid-feedback"> Looks good! </div>
                        </div>
                    </div>
...
<script>
   document.querySelectorAll('.edit-education-btn').forEach(button => {
    button.addEventListener('click', function () {
        ...
        // Set the form's action attribute to the route for updating the education
        document.getElementById('editeducationForm').setAttribute('action', `/education/${educationId}`);

        // Populate the education name in the modal
        document.getElementById('editeducationName').value = educationName;
