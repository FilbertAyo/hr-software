    ...
    <div class="row align-items-center mb-3 border-bottom no-gutters">
            ...
            <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                        aria-controls="home" aria-selected="true">Education Levels</a>
                </li>
        ...
        <div class="col-auto">
            ...
            <button type="button" class="btn mb-2 btn-primary btn-sm" data-toggle="modal" data-target="#varyModal"
                data-whatever="@mdo">New education<span class="fe fe-plus fe-16 ml-2"></span></button>
        </div>
    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="" id="editeducationForm">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <input type="text" class="form-control" id="editeducationName"
                                            name="education_level" required>
                                        <div class="valid-feedback"> Looks good! </div>
                                    </div>
                                </div>
            ...
            <script>
                document.querySelectorAll('.edit-education-btn').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        document.getElementById('editeducationForm').setAttribute('action',
