            ...
            <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                        aria-controls="home" aria-selected="true">payments</a>
                </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($payment->payment_type == 'Dynamic')
                                                <span
                                                    class="badge badge-{{ $payment->rate_check ? 'success' : 'warning' }}">
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-{{ $payment->status == 'Active' ? 'success' : 'danger' }}">
                                                {{ $payment->status }}
                                            </span>
                                        </td>
                                        <td class="text-right">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-3" id="add_rate_check_div">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="add_rate_check"
                                        name="rate_check" onchange="toggleRateInput('add')">
                            ...
                            <div class="col-md-12 mb-3" id="add_payment_rate_div" style="display: none;">
                                ...
                                <input type="number" class="form-control" id="add_payment_rate" name="payment_rate"
                    ...
                    <form method="POST" action="" id="editpaymentForm">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="edit_payment_name"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-control" id="edit_payment_type" name="payment_type" required
                                    onchange="toggleRateFields('edit')">
                                    <option value="Dynamic">Dynamic</option>
                                    <option value="Static">Static</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 mb-3" id="edit_rate_check_div">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="edit_rate_check"
                                        name="rate_check" onchange="toggleRateInput('edit')">
                            ...
                            <div class="col-md-12 mb-3" id="edit_payment_rate_div" style="display: none;">
                                ...
                                <input type="number" class="form-control" id="edit_payment_rate"
                                    name="payment_rate" step="0.01" min="0" max="100">
                            </div>
