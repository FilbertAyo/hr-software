                ...
                <div class="row align-items-center mb-3 border-bottom no-gutters">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="button" class="btn btn-sm" onclick="reloadPage()">
                            ...
                            <button type="button" class="btn mb-2 btn-primary btn-sm" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo">New termination<span
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div style="display: flex; gap: 4px; justify-content: flex-end;">
                                                        ...
                                                        data-termination-name="{{ $termination->termination }}">
...
<div class="modal-content">
    ...
    <div class="modal-body">
        <form method="POST" action="" id="editterminationForm">
            ...
            <div class="form-row">
                <div class="col-md-12 mb-3">
                    <input type="text" class="form-control" id="editterminationName" name="termination" required>
                    <div class="valid-feedback"> Looks good! </div>
                </div>
            </div>
