                        ...
                        <div class="row align-items-center mb-3 border-bottom no-gutters">
                            ...
                            <div class="col-auto">
                                ...
                                <button type="button" class="btn btn-sm" onclick="reloadPage()">
                                    ...
                                    <button type="button" class="btn mb-2 btn-primary btn-sm" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo">New relation<span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <div style="display: flex; gap: 4px; justify-content: flex-end;">
                                                                ...
                                                                <form action="{{ route('relation.destroy', $relation->id) }}" method="POST"
...
<script>
   document.querySelectorAll('.edit-relation-btn').forEach(button => {
    button.addEventListener('click', function () {
        ...
        document.getElementById('editrelationForm').setAttribute('action', `/relation/${relationId}`);
