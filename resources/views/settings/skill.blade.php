    ...
    <div class="row align-items-center mb-3 border-bottom no-gutters">
            ...
            <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                        aria-controls="home" aria-selected="true">Skills</a>
                </li>
        ...
        <div class="col-auto">
            ...
            <button type="button" class="btn mb-2 btn-primary btn-sm" data-toggle="modal" data-target="#varyModal"
                data-whatever="@mdo">New Skill<span class="fe fe-plus fe-16 ml-2"></span></button>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered datatables" id="dataTable-1">
                        ...
                        <tbody>
                            ...
                            @else
                                <tr>
                                    <td colspan="3" class="text-center">No Skill found</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="varyModalLabel">New Skill</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('skill.store') }}" validate>
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <input type="text" class="form-control" id="validationCustom3" name="skill_name"
                                    required>
    ...
    <div class="modal fade" id="editSkillModal" tabindex="-1" role="dialog" aria-labelledby="editSkillModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="" id="editSkillForm">
                        @csrf
                        @method('PUT')
    ...
    <script>
        document.querySelectorAll('.edit-skill-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Set the form's action attribute to the route for updating the skill
                document.getElementById('editSkillForm').setAttribute('action', `/skill/${skillId}`);

                // Populate the skill name in the modal
