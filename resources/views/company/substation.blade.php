                        ...
                        <div class="row align-items-center mb-3 border-bottom no-gutters">
                            ...
                            <div class="col-auto">
                                ...
                                <button type="button" class="btn btn-sm" onclick="reloadPage()">
                                    ...
                                    <button type="button" class="btn mb-2 btn-primary btn-sm" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo">New substation<span
...
<div class="modal fade" id="editsubstationModal" tabindex="-1" role="dialog" aria-labelledby="editsubstationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
