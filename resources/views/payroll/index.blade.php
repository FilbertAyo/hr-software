                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h6 mb-0 text-gray-800">
                                    {{ $payrollStats['processed_employees'] }} of {{ $payrollStats['total_employees'] }}
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <div class="alert alert-info mb-3">
                            ...
                            <strong>Note:</strong> Only employees with "Active" status are eligible for payroll
                            processing.
                            Employees with "On Hold" (on leave) or "Inactive" status are automatically excluded from
                            payroll processing.
                                        ...
                                        @foreach ($employees as $employee)
                                            @php
                                                ...
                                                if ($payroll) {
                                                    ...
                                                    $pensionAmount = 0;
                                                    if (
                                                        $employee->pension_details &&
                                                        $employee->pension_id &&
                                                        $employee->pension
                                                    ) {
                                                        $baseAmount =
                                                            $employee->pension->percentage_of === 'basic'
                                                                ? $basicSalary
                                                                : $grossSalary;
                                                        $pensionAmount =
                                                            ($baseAmount *
                                                                floatval($employee->pension->employee_percent)) /
                                                            100;
                                                    }
