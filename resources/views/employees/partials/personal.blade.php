            ...
            <div class="form-row">
                    ...
                    <select class="form-control" id="nationality"
                        ...
                        @foreach ($nationalities as $nationality)
                            <option value="{{ $nationality->id }}"
                                {{ old('nationality_id') == '$nationality->nationality' ? 'selected' : '' }}>
                    ...
                    <select class="form-control" id="religion"
                        ...
                        @foreach ($religions as $religion)
                            <option value="{{ $religion->id }}"
                                {{ old('religion_id') == '$religion->religion' ? 'selected' : '' }}>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control" id="employee_type"
                        ...
                        <option value="">Select Employee Type
                        </option>
                        <option value="permanent"
                            {{ old('employee_type') == 'permanent' ? 'selected' : '' }}>
                            Permanent
                        </option>
                        <option value="casual"
                            {{ old('employee_type') == 'casual' ? 'selected' : '' }}>
                            Casual
                        </option>
                        ...
                        <option value="probation"
                            {{ old('employee_type') == 'probation' ? 'selected' : '' }}>
                            Probation
                        </option>
                        <option value="consultant"
                            {{ old('employee_type') == 'consultant' ? 'selected' : '' }}>
                            Consultant
                        </option>
                    </select>
                </div>
                ...
                <!-- Employee Status -->
                <div class="col-md-3 mb-3">
                    <label for="employee_status">Employee
                        Status</label>
                    <select class="form-control" id="employee_status"
                        name="employee_status">
                        <option value="active"
                            {{ old('employee_status') == 'active' ? 'selected' : '' }}>
                            Active</option>
                        <option value="inactive"
                            {{ old('employee_status') == 'inactive' ? 'selected' : '' }}>
                            Inactive</option>
                        <option value="inactive"
                            {{ old('employee_status') == 'onhold' ? 'selected' : '' }}>
                ...
                <!-- Residential Status -->
                <div class="col-md-3 mb-3">
                    <label for="residential_status">Residential
                        Status</label>
                    <select class="form-control"
                        id="residential_status"
                        name="residential_status">
                        <option value="residential"
                            {{ old('residential_status') == 'residential' ? 'selected' : '' }}>
                            Residential</option>
                        <option value="non_residential"
                            {{ old('residential_status') == 'non_residential' ? 'selected' : '' }}>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control" id="tax_rate_id"
                        name="tax_rate_id" required>
                        <option value="">Select Tax rate type
                        </option>
                        @foreach ($tax_rates as $tax_rate)
                            <option value="{{ $tax_rate->id }}"
                                {{ old('tax_rate_id') == $tax_rate->id ? 'selected' : '' }}>
                                {{ $tax_rate->name }}
                            </option>
                        @endforeach
                    </select>
