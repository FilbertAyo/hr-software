                        ...
                        <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                                    role="tab" aria-controls="home" aria-selected="true">Assign Leave</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row my-2">
                    <div class="col-md-12">
                        <div class="card shadow-none border">
                            <div class="card-body">
                                <form method="POST" action="{{ route('leaves.store') }}" id="leaveAssignForm">
                                    @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" id="leave_action" name="leave_action" required>
                                                ...
                                                <option value="proceed" {{ old('leave_action') == 'proceed' ? 'selected' : '' }}>Proceed on Leave</option>
                                                <option value="sold" {{ old('leave_action') == 'sold' ? 'selected' : '' }}>Sold Leave</option>
                                                <option value="emergency" {{ old('leave_action') == 'emergency' ? 'selected' : '' }}>Emergency Leave</option>
                                                <option value="compensatory" {{ old('leave_action') == 'compensatory' ? 'selected' : '' }}>Compensatory Leave</option>
                                            </select>
                                            @error('leave_action')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="no_of_days" name="no_of_days"
                                                   value="{{ old('no_of_days') }}" min="1" required readonly>
                                            @error('no_of_days')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary">
                                                <span class="fe fe-save fe-16 mr-2"></span>Assign Leave
                                            </button>
