                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" id="leave_action" name="leave_action" required>
                                                ...
                                                <option value="proceed_on_leave" {{ old('leave_action') == 'proceed_on_leave' ? 'selected' : '' }}>Proceed on Leave</option>
                                                <option value="sold_leave" {{ old('leave_action') == 'sold_leave' ? 'selected' : '' }}>Sold Leave</option>
                                            </select>
                                            @error('leave_action')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
