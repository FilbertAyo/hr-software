<x-app-layout>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="page-title">Employee Attendance Details</h1>
                        <ol class="breadcrumb">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <strong>Department:</strong> {{ $employee->department->department->department_name ?? 'N/A' }}
                        </div>
                        <div class="col-md-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="align-self-center">
                            <div class="h5 mb-0 text-danger">{{ $employee->absentRecords->sum('used_days') }}</div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="align-self-center">
                            <div class="h5 mb-0 text-warning">{{ $employee->lateRecords->sum('amount') }}</div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="align-self-center">
                            <div class="h5 mb-0 text-info">{{ $employee->absentRecords->count() + $employee->lateRecords->count() }}</div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="align-self-center">
                            <div class="h5 mb-0 text-success">{{ $employee->absentRecords->where('status', 'approved')->count() + $employee->lateRecords->where('status', 'approved')->count() }}</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Absent Records</h3>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-danger">{{ $record->used_days }} {{ $record->used_days == 1 ? 'day' : 'days' }}</span>
                                    </td>
                                    <td>{{ $record->reason }}</td>
                                    <td>{{ $record->notes ?? 'N/A' }}</td>
                                    <td>
                                        <span class="badge badge-{{ $record->status == 'approved' ? 'success' : ($record->status == 'rejected' ? 'danger' : 'warning') }}">
                                            {{ ucfirst($record->status) }}
                                        </span>
                                    </td>
                                    <td>{{ $record->approver->name ?? 'N/A' }}</td>
                                    <td>{{ $record->approved_at ? $record->approved_at->format('M d, Y H:i') : 'N/A' }}</td>
                                    <td>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Late Records</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    {{-- <td>{{ $record->activity_date->format('M d, Y') }}</td> --}}
                                    <td>{{ $record->expected_time ? \Carbon\Carbon::parse($record->expected_time)->format('H:i') : 'N/A' }}</td>
                                    <td>{{ $record->late_time ? \Carbon\Carbon::parse($record->late_time)->format('H:i') : 'N/A' }}</td>
                                    <td>
                                        <span class="badge badge-warning">{{ $record->amount ?? 0 }} {{ ($record->amount ?? 0) == 1 ? 'hour' : 'hours' }}</span>
                                    </td>
                                    <td>{{ $record->reason }}</td>
                                    <td>{{ $record->notes ?? 'N/A' }}</td>
                                    <td>
