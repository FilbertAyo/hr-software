                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($leavetype->description)
                                                <br><small
                                                    class="text-muted">{{ Str::limit($leavetype->description, 30) }}</small>
                                            @endif
                                        </td>
                                            ...
                                            @if ($leavetype->carry_forward)
                                                ...
                                                @if ($leavetype->max_carry_forward_days)
                                                    <br><small class="text-muted">Max:
                                                        {{ $leavetype->max_carry_forward_days }}</small>
                                                @endif
                                            @else
                                                <span class="badge badge-secondary">No</span>
                                            @endif
                    ...
                    <form method="POST" action="{{ route('leavetype.store') }}" id="createForm">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="leave_type_name" id="leave_type_name"
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3" id="monthly_increment_field" style="display: none;">
                                ...
                                <input type="number" class="form-control" name="no_of_monthly_increment"
                                    id="no_of_monthly_increment_input" placeholder="0" min="0"
                                    step="0.01">
                            </div>
                            <div class="col-md-6 mb-3" id="extra_days_field" style="display: none;">
                                <label for="extra_days">Extra Days Value</label>
                                <input type="number" class="form-control" name="extra_days" id="extra_days_input"
                                    placeholder="0" min="0">
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="" id="editleavetypeForm">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="editleavetypeName">Leave Type Name <span
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="editleavetypeDays" name="no_of_days"
                                    min="0">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3" id="edit_extra_days_field" style="display: none;">
                                ...
                                <input type="number" class="form-control" id="editleavetypeExtra" name="extra_days"
                                    min="0">
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
                if (e.target.closest('.edit-leavetype-btn')) {
                    ...
                    const leavetypeMaxCarryForward = button.getAttribute(
                    'data-leavetype-max-carry-forward');
                    const leavetypeRequiresApproval = button.getAttribute(
                        'data-leavetype-requires-approval');
                    const leavetypeRequiresDoc = button.getAttribute('data-leavetype-requires-doc');

                    // Set form action
                    document.getElementById('editleavetypeForm').setAttribute('action',
