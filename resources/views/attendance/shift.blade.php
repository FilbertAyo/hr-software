                            ...
                            <form id="punchForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="btn-group w-100" role="group">
                                        <button type="button" class="btn btn-success punch-action" data-action="punch_in">
                                            <i class="fe fe-log-in"></i> Punch In
                                        </button>
                                        <button type="button" class="btn btn-warning punch-action" data-action="break_start">
                                            <i class="fe fe-pause"></i> Break Start
                                        </button>
                                        <button type="button" class="btn btn-info punch-action" data-action="break_end">
                                            <i class="fe fe-play"></i> Break End
                                        </button>
                                        <button type="button" class="btn btn-danger punch-action" data-action="punch_out">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="punch_time" id="bulk_punch_time" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Employees</label>
                                            <select name="employee_ids[]" id="bulk_employee_ids" class="form-control" multiple required>
                                                @foreach(\App\Models\Employee::where('company_id', session('selected_company_id'))->where('employee_status', 'active')->get() as $employee)
                                                <option value="{{ $employee->id }}">
                                                    {{ $employee->employeeID }} - {{ $employee->employee_name }}
                                                </option>
                ...
                <form id="shiftForm" method="POST" action="{{ route('shift.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="break_duration_minutes" id="break_duration_minutes" class="form-control" value="60" min="0" max="480">
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="editShiftForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="edit_shift_name" class="form-label">Shift Name <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="edit_break_duration_minutes" class="form-label">Break Duration (minutes)</label>
                            <input type="number" name="break_duration_minutes" id="edit_break_duration_minutes" class="form-control" min="0" max="480">
                        </div>
                        <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $('#punch_employee_id').change(function() {
            ...
            if (employeeId) {
                ...
                $('#todayStatus').html('<p class="text-muted">Select an employee to view today\'s punch status.</p>');
            }
        });
