...
return new class extends Migration
{
    ...
    {
       // Skip payroll_periods table creation as it already exists
       // Only create payrolls table
    ...
    public function down(): void
    {
        ...
        // Don't drop payroll_periods as it might be used by other parts of the system
    }
};
